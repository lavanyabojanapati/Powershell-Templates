...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models
{
    ...
    /// </summary>
    public partial class PSPeeringPrefixProperties
    {
        /// <summary>
        /// Initializes a new instance of the PSPeeringPrefixProperties class.
        /// </summary>
        public PSPeeringPrefixProperties()
        {
            CustomInit();
        }
        ...
        public PSPeeringPrefixProperties(string prefix = default(string), string validationState = default(string), string learnedType = default(string), string provisioningState = default(string))
        {
            Prefix = prefix;
