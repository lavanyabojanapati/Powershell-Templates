...
namespace Microsoft.Azure.PowerShell.Cmdlets.Peering.Models
{
    ...
    public partial class PSPeeringPrefix
    {
        ...
        public PSPeeringPrefix(string prefix = default(string), string validationState = default(string), string learnedType = default(string), string provisioningState = default(string), string name = default(string), string id = default(string), string type = default(string), string location = default(string), string eTag = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Prefix = prefix;
