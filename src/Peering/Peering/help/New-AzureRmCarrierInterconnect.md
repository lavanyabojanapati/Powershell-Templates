...
```
New-AzureRmPeeringService [-PeeringName] <String> [-ResourceGroupName] <String>
 -PeeringLocation <String> -CarrierName <String> [-AsJob] [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```
