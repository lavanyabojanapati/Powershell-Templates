...
param(
    ...
    process {
        ...
        $UploadInfo = Get-AzAppPlatformAppResourceUploadUrl -ResourceGroupName wyunchi-app-platform -serviceName wyunchi-pwsh-app-platform -AppName gateway @DeployPSBoundParameters
